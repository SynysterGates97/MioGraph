...
#define COPY_P2P_NOTIFY_MIO_ARRAY_UPDATE_UUID(uuid_struct)       	COPY_UUID_128(uuid_struct,0x00,0x00,0xfe,0x43,0x8e,0x22,0x45,0x41,0x9d,0x4c,0x21,0xed,0xae,0x82,0xed,0x19)
...
void P2PS_STM_Init(void)
{
  ...
  SVCCTL_RegisterSvcHandler(PeerToPeer_Event_Handler);
    ...
    /**
     *   Add MIO Characteristics
     */
    COPY_P2P_NOTIFY_MIO_ARRAY_UPDATE_UUID(uuid16.Char_UUID_128);
    aci_gatt_add_char(aPeerToPeerContext.PeerToPeerSvcHdle,
                      UUID_TYPE_128, &uuid16,
                      256,
                      CHAR_PROP_NOTIFY,
